				...
				<div class="row">
					<div class="col-lg-4 col-xl-4">
						<div class="card-box text-center">
							...
							<h4 class="mb-0">Cu Vi Tuan Anh</h4>
							<p class="text-muted">@VietUc</p>
							...
							<div class="text-left mt-3">
								...
								<p class="text-muted font-13 mb-3">
									Hi I'm Johnathn Deo,has been the industry's
								...
								<p class="text-muted mb-2 font-13">
									...
									<span class="ml-2">Nik G. Patel</span>
								</p>
						...
						<div class="card-box">
							...
							<div class="pt-1">
								<h6 class="text-uppercase mt-0">
									HTML5 <span class="float-right">90%</span>
								</h6>
							...
							<div class="mt-2 pt-1">
								<h6 class="text-uppercase">
									PHP <span class="float-right">67%</span>
								</h6>
								<div class="progress progress-sm m-0">
									<div
										class="progress-bar bg-purple"
							...
							<div class="mt-2 pt-1">
								<h6 class="text-uppercase">
									Laravel <span class="float-right">95%</span>
								</h6>
								<div class="progress progress-sm m-0">
									<div
										class="progress-bar bg-purple"
							...
							<div class="mt-2 pt-1">
								<h6 class="text-uppercase">
									ReactJs <span class="float-right">72%</span>
								</h6>
								<div class="progress progress-sm m-0">
									<div
										class="progress-bar bg-purple"
